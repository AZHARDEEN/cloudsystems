package br.com.mcampos.ejb.cloudsystem.user.attribute.contacttype.entity;
...
@Entity
@NamedQueries( { @NamedQuery( name = ContactType.getAll, query = "select o from ContactType o" ),
                 @NamedQuery( name = ContactType.nextId, query = "select max(o.id) from ContactType o" ) } )
@Table( name = "contact_type" )
public class ContactType implements Serializable
{
    public static final String getAll = "ContactType.findAll";
    public static final String nextId = "ContactType.nextId";
