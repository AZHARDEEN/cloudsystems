...
public class PgcAttachmentPK implements Serializable
{
    ...
    public PgcAttachmentPK( Integer pat_book_id, Integer pat_page_id,
                            Integer pat_seq_in, Integer pgc_id_in )
    {
    ...
    public boolean equals( Object other )
    {
        if (other instanceof PgcAttachmentPK) {
            ...
            final boolean areEqual =
                (otherPgcAttachmentPK.bookId.equals(bookId) && otherPgcAttachmentPK.pageId.equals(pageId) && otherPgcAttachmentPK.sequence.equals(sequence) && otherPgcAttachmentPK.pgcId.equals(pgcId));
            return areEqual;
        }
        return false;
    }
