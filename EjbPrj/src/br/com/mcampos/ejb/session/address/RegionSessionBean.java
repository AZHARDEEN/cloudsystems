...
public class RegionSessionBean implements RegionSession, RegionSessionLocal
{
	...
	public List<Region> getRegionByCriteria( String jpqlStmt, int firstResult, int maxResults )
	{
	 ...
	 */
	@TransactionAttribute( value = TransactionAttributeType.NOT_SUPPORTED )
	public List<Region> getRegionFindAllByRange( int firstResult, int maxResults )
	{
