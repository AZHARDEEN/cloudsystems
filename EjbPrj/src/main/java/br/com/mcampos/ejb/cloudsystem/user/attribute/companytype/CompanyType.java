...
@Entity
@NamedQueries( { @NamedQuery( name = CompanyType.getAll, query = "select o from CompanyType o" ),
                 @NamedQuery( name = CompanyType.nextId, query = "select max(o.id) from CompanyType o" ) } )
