/**
 * InovadoraWSPortBindingStub.java
 *
...
public class InovadoraWSPortBindingStub extends org.apache.axis.client.Stub implements br.com.mcampos.web.fdigital.samabsd.webservice.InovadoraWS
{
	...
	private static void _initOperationDesc1( )
	{
		...
		oper = new org.apache.axis.description.OperationDesc( );
		oper.setName( "addFicha" );
		param = new org.apache.axis.description.ParameterDesc( new javax.xml.namespace.QName( "", "xmlContent" ),
				org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName( "http://www.w3.org/2001/XMLSchema",
						"string" ), java.lang.String.class, false, false );
		param.setOmittable( true );
		oper.addParameter( param );
	...
	public InovadoraWSPortBindingStub( ) throws org.apache.axis.AxisFault
	{
		this( null );
	}

	public InovadoraWSPortBindingStub( java.net.URL endpointURL, javax.xml.rpc.Service service ) throws org.apache.axis.AxisFault
	{
		this( service );
		super.cachedEndpoint = endpointURL;
	}

	public InovadoraWSPortBindingStub( javax.xml.rpc.Service service ) throws org.apache.axis.AxisFault
	{
		if ( service == null ) {
	...
	public java.lang.Integer xmlType( java.lang.String arg0 ) throws java.rmi.RemoteException
	{
		...
		_call.setOperationName( new javax.xml.namespace.QName( "http://webservice.samabsd.com.br/", "xmlType" ) );
	...
	public void addFicha( java.lang.String xmlContent ) throws java.rmi.RemoteException
	{
		...
		_call.setProperty( org.apache.axis.AxisEngine.PROP_DOMULTIREFS, Boolean.FALSE );
		_call.setSOAPVersion( org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS );
		_call.setOperationName( new javax.xml.namespace.QName( "http://webservice.samabsd.com.br/", "addFicha" ) );

		setRequestHeaders( _call );
		setAttachments( _call );
		try {
			java.lang.Object _resp = _call.invoke( new java.lang.Object[ ] { xmlContent } );
