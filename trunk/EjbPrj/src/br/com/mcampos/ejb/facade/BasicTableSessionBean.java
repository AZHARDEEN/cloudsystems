...
{
	@EJB
	CivilStateSessionLocal civilState;
	@EJB
	AddressTypeSessionLocal addressType;
	@EJB
	ContactTypeSessionLocal contactType;
	@EJB
	DocumentTypeSessionLocal documentType;
	@EJB
	UserStatusSessionLocal userStatus;
	@EJB
	UserTypeSessionLocal userType;
	@EJB
	CountrySessionLocal country;
	@EJB
	TableManagerSessionLocal tableManager;
	@EJB
	SystemMessagesSessionLocal systemMessage;
	@EJB
	StateSessionLocal state;
	@EJB
	CitySessionLocal city;
	...
	public List<CityDTO> getAllStateCities( String countryId, Integer stateId ) throws ApplicationException
	{
		testParam( countryId );
		testParam( stateId );
