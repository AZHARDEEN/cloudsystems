...
@NamedQueries({ @NamedQuery(name = "Region.findAll", query = "select o from Region o") ,
                @NamedQuery(name = "Region.findByCountry",
                            query = "select o from Region o where o.countryId = :countryId") })
@Table(name = "\"region\"")
...
public class Region implements Serializable {
    ...
    public Region(Country country, String reg_abbreviation_ch, String reg_flag_bin, Integer reg_id_in,
                  String reg_name_ch) {
