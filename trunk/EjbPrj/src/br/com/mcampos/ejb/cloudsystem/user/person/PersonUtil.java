...
public class PersonUtil extends UserUtil
{
    ...
    public static Person update( Person person, PersonDTO dto )
    {
        ...
        person.setUserType( UserTypeUtil.createEntity( dto.getUserType() ) );
        ...
        person.setBornCity( CityUtil.createEntity( dto.getBornCity() ) );
        return person;
    }
    ...
    public static PersonDTO copy( Person person )
    {
        ...
        dto.setBornCity( CityUtil.copy( person.getBornCity() ) );
