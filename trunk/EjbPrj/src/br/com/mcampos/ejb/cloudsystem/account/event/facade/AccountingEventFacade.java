...
public interface AccountingEventFacade extends Serializable
{
    ...
    List<AccountingRateTypeDTO> getRateTypes() throws ApplicationException;

    List<AccountingPlanDTO> getAccountNumbers( AuthenticationDTO auth, Integer maskId ) throws ApplicationException;
