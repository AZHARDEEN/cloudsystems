...
public class StateSessionBean implements StateSession, StateSessionLocal
{
	...
	public void delete( String countryID, Integer regionId, Integer id )
	{
		State state;
	...
	public List<StateDTO> getAll()
	{
		...
		list = ( em.createNamedQuery( State.getAll ).getResultList() );
		if ( list == null )
	...
	public List<StateDTO> getAll( Integer countryId )
	{
		...
		list = em.createNamedQuery( State.getAllByCountry ).setParameter( "countryId", countryId ).getResultList();
		return getDTOList( list );
	}
}
