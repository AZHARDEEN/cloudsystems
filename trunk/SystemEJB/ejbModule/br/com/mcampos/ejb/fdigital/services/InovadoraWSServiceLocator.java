...
public class InovadoraWSServiceLocator extends org.apache.axis.client.Service implements br.com.mcampos.ejb.fdigital.services.InovadoraWSService
{
	...
	@Override
	public br.com.mcampos.ejb.fdigital.services.InovadoraWS getInovadoraWSPort( ) throws javax.xml.rpc.ServiceException
	{
	...
	@Override
	public br.com.mcampos.ejb.fdigital.services.InovadoraWS getInovadoraWSPort( java.net.URL portAddress )
			throws javax.xml.rpc.ServiceException
	{
		try {
			br.com.mcampos.ejb.fdigital.services.InovadoraWSPortBindingStub _stub = new br.com.mcampos.ejb.fdigital.services.InovadoraWSPortBindingStub(
					portAddress, this );
	...
	{
		try {
			if ( br.com.mcampos.ejb.fdigital.services.InovadoraWS.class.isAssignableFrom( serviceEndpointInterface ) ) {
				br.com.mcampos.ejb.fdigital.services.InovadoraWSPortBindingStub _stub = new br.com.mcampos.ejb.fdigital.services.InovadoraWSPortBindingStub(
