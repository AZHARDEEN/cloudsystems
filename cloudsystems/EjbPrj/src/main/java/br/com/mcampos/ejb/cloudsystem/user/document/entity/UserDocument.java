...
@Entity
@NamedQueries( {
		@NamedQuery( name = UserDocument.getAll, query = "select o from UserDocument o" ),
...
public class UserDocument implements Serializable, Comparable<UserDocument>
{
	...
	{
		documentId = doc_id_in;
	}

	public void setDocumentId( DocumentType type )
	{
		documentId = type != null ? type.getId( ) : null;
	}
	...
	{
		additionalInfo = udc_additional_ch;
	}
