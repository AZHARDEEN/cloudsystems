...
public class LoginSessionBean extends AbstractSecurity implements LoginSessionLocal
{
	...
	/**
	 * Adiciona um novo loginSession ao sistema. Para adicionar este loginSession, deve ser observado que o mesmo depende do relacionamento com a entidade
	 * pessoa. Após incluido o loginSession com os dados mais básicos necessários, o novo usuário do sistema DEVE completar o registro.
	 * 
	 * @param dto
	...
	/**
	 * Verifica se a lista de documentos inforamada é suficiente para o cadastramento do novo loginSession. Neste momento, devem existir ao menos um email
	 * e um cpf
	 * 
	 * @param list
	 *            Lista de documentos
	...
	/**
	 * Rotina responsável por obter o template de email, configurar os metacampos e enviar o email. Fica claro que este rotina serve somente para os emails
	...
	/**
	 * Configura a data em que a senha irá expirar. Neste momento está configurada para 60 dias como padrão.
	 * 
	 * @param login
	 *            Entity Login
	 * @see #Login
	...
	/**
	 * Exclui um loginSession ativo no banco de dados. Um loginSession não deve ser excluído fisicamente do banco de dados. Estou pensando somente em
	 * fechar (Data fim).
	 * 
	 * @param id
	...
	/**
	 * Finaliza a sessão do usuário (no banco de dados). Este função tem como finalidade incluir um registro no banco de dados finalizando o loginSession.
	 * 
	 * @param dto
	 *            AuthenticationDTO
	 */
	...
	/**
	 * Dado uma lista de documentos, obter o loginSession associado aos documentos. Uma regra: todos os documentos DEVEM pertencer a um e somente um
	 * loginSession.
	 * 
	 * @param list
	 * @return
	...
	/**
	 * Para todo o acesso ao sistema ( Login, Logout, troca de senha, etc) um registro de log será gravado.
	 * 
	 * @param login
	 *            Entity Login.
	 * @param dto
	...
	/**
	 * Quando uma senha é alterada, a senha antiga é armazenada no banco de dados e o sistema não permite que esta senha seja usada novamente pelo mesmo
	 * loginSession.
	 * 
	 * 
	 * @param login
	...
	/**
	 * Altera a senha do usuário. Deve-se imaginar que o usuario não está logado no sistema para alterar a sua senha.
	 * 
	 * @param document
	 *            UserDocumentDTO - identificado do usuario via documento (Email)
	 * @param oldPassword
	...
	/**
	 * O sistema não permite que uma senha seja usada mais de uma vez. Assim, esta função verifica a existência de uma senha usada anteriormente por um
	 * mesmo usuário.
	 * 
	 * @param login
	 *            Entity Login
	...
	/**
	 * Quando o usuário erra a senha ao acessar o site, é incrementado um contador de erros. Quando este valor ultrapassa o máximo de número de tentativas,
	...
	/**
	 * Valida o email informado no ato do cadastro. Quando o usuario se cadastra no sistema, deve obrigatóriamente informar um email válido e único no
	 * sistema. Este será a 'identidade' do usuário no sistema, e, portanto, este email deve ser validado.
	 * 
	 * 
	 * @param token
	 *            Código gerado pelo sistema e enviado ao email do novo cadastro. Este token deve ser único no sistema.
	 * @param password
	 *            Senha de validação. Este é a senha informada pelo usuário no ato do cadstro
	 * @exception InvalidParameterException
	 */
	@Override
	...
	/**
	 * Quando um novo usuário se cadastra no sistema, é enviado um email de confirmação com um código de acesso (token). Este código é usado para validar o
	 * email dentro do sistema. Esta função localiza o novo loginSession através deste token - que por sua vez deve ser único no sistema.
	 * 
	 * @param token
