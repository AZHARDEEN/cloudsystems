...
public class PgcPenPageSessionBean extends Crud<PgcPenPagePK, PgcPenPage> implements PgcPenPageSessionLocal
{
	 ...
	 * 
	 */
	private static final long serialVersionUID = 6952665777252925474L;
	...
	private static final Logger LOGGER = LoggerFactory.getLogger( PgcPenPageSessionBean.class.getSimpleName( ) );
	...
	public List<PgcPage> getAll( Properties props, Integer maxRecords, Boolean bNewFirst ) throws ApplicationException
	{
		...
		LOGGER.info( jpaQuery );
		Query query = this.getEntityManager( ).createNativeQuery( jpaQuery, PgcPage.class );
	...
	{
		this.delete( PgcPenPage.class, key );
	}
	...
	{
		return this.get( PgcPenPage.class, key );
	}

	@Override
	public void delete( Pgc entity ) throws ApplicationException
	{
		Query query = this.getEntityManager( ).createNamedQuery( PgcPenPage.deleteFromPgc );
