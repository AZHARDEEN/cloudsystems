...
import br.com.mcampos.ejb.cloudsystem.user.UserFacadeSession;
...
public class UsersLocator extends BusinessDelegate
{
	...
	*/
	...
	/**
	 * Obtem todas as roles do usuário autenticado. As roles são a base para todo o esquema de segurança do sistema. Inclusive para obter o parentMenu de
	 * acesso ao sistema.
	 * 
	 * @param auth
