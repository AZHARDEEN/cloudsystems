    ...
    public CityDTO getCity ( String cidade, String estado, String bairro )
    {
        ...
        if ( estado.equals("GO") ) 
        {
            if ( cidade.equals( "CIDADE OCIDENTAL") )
                dto.setId( 942 );
            else if ( cidade.length() >= 10 && ( cidade.substring(0, 10).equals("VALPARAIZO") || cidade.substring(0, 10).equals ( "VALPARAISO" ) ) )
                dto.setId( 1115 );
            ...
            while ( ( strRead = readbuffer.readLine() ) != null ) {
                ...
                try {                
                    ...
                    if ( splitarray[11].length() > 0 )
                        dto.add( new UserContactDTO (new ContactTypeDTO (1, null, null, null), splitarray[11].replaceAll("[ .-]", ""), "Conteudo Oringinal: " + splitarray[11] ) );
                    if ( splitarray[12].length() > 0 && splitarray[11].equals( splitarray[12] ) == false )
                        dto.add( new UserContactDTO (new ContactTypeDTO (2, null, null, null), splitarray[12].replaceAll("[ .-]", ""), "Conteudo Oringinal: " + splitarray[12] ) );
                    if ( splitarray[13].length() > 0 && splitarray[13].equals( splitarray[12] ) == false && splitarray[13].equals( splitarray[11] ) == false)
                        dto.add( new UserContactDTO (new ContactTypeDTO (3, null, null, null), splitarray[13].replaceAll("[ .-]", ""), "Conteudo Oringinal: " + splitarray[13] ) );
