...
public class InovadoraWSProxy implements br.com.mcampos.ejb.fdigital.services.InovadoraWS
{
	private String _endpoint = null;
	private br.com.mcampos.ejb.fdigital.services.InovadoraWS inovadoraWS = null;
	...
	{
		try {
			this.inovadoraWS = ( new br.com.mcampos.ejb.fdigital.services.InovadoraWSServiceLocator( ) ).getInovadoraWSPort( );
	...
	public br.com.mcampos.ejb.fdigital.services.InovadoraWS getInovadoraWS( )
	{
		if ( this.inovadoraWS == null ) {
			_initInovadoraWSProxy( );
		}
