...
public abstract class BaseUserSession<BEAN extends Users> extends SimpleSessionBean<BEAN>
{
	...
	{
		this.configAttributes( newEntity );
	...
	{
		return this.documentSession.searchByDocument( documentType, lookFor );
	}

	public List<UserDocument> searchByCPF( String lookFor )
	{
		return this.documentSession.searchByCPF( lookFor );

	}

	public List<UserDocument> searchByEmail( String lookFor )
	{
		return this.documentSession.searchByEmail( lookFor );

	}

	protected void configureDefault( Users user )
	{
		if ( user.getInsertDate( ) == null ) {
