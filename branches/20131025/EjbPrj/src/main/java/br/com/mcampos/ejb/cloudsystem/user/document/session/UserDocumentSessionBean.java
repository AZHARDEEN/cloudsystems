...
public class UserDocumentSessionBean extends Crud<UserDocumentPK, UserDocument> implements UserDocumentSessionLocal
{
	 ...
	 * 
	 * @param dto
	 *            DTO com os dados a serem localizados no banco de dados
	 ...
	 * 
	 * @param entity
	 *            Entity Bean com os dados a serem localizados no banco de dados
	 * @return UserDocument Entity Bean
	 * @exception InvalidParameterException
	 */
	@Override
	 ...
	 * 
	 * @param document
	 *            Código (Número, ID) do documento
	 * @param docTypeId
	 *            Código sequencial inteiro do tipo do documento
	 * @return UserDocument Entity Bean
	 * @exception InvalidParameterException
	 */
