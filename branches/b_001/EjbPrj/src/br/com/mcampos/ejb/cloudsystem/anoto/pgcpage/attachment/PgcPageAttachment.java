...
@NamedQueries( { @NamedQuery( name = PgcPageAttachment.findAll, query = "select o from PgcPageAttachment o" ),
				 @NamedQuery( name = PgcPageAttachment.findOtherBarCode,
							  query = "select o from PgcPageAttachment o where o.value = ?1 and o.type = 1 and o.pgcPage.anotoPage.pageAddress = ?2 and o.pgcPage.anotoPage.pad.id = ?3 and o.pgcId <> ?4" ),
