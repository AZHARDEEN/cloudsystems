...
@MessageDriven( activationConfig = { @ActivationConfigProperty( propertyName = "destinationType", propertyValue = "javax.jms.Queue" ), @ActivationConfigProperty( propertyName = "destination", propertyValue = EmailMessageSessionBean.destinationName ) }, mappedName = EmailMessageSessionBean.destinationName )
public class EmailMessageSessionBean implements MessageListener
{
	public static final String destinationName = "cloudq";
